...
def visualize(
    ...
    key: str=None,
    ignore_hover: bool=False,
    ignore_click: bool=False,
    fontFamily: str="Times New Roman",
    deterministic:bool = True,
    enableOptimizations:bool = True,
    width_react: int = None,
    height_react: int = None,
    ...
    ignore_hover: bool
        If True, the `hovered` dictionary will not be returned.
    ...
    component_value = _wordcloud(
        ...
        ignore_hover=ignore_hover,
        fontFamily=fontFamily,
        deterministic=deterministic,
        enableOptimizations=enableOptimizations,
        width_react = width_react,
        height_react = height_react,
    )
