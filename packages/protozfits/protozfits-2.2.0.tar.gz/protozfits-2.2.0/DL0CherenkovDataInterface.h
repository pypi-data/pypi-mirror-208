    ...
    */
    class AbstractEvent
    {
        public:
            ...
            */
            virtual uint16_t* getPixelStatus() = 0;
            virtual const uint16_t* getPixelStatus() const = 0;
            ...
            /**
                ...
                and upon querying this method again.
            */
            virtual uint32_t* getFirstCellId() = 0;
            virtual const uint32_t* getFirstCellId() const = 0;
