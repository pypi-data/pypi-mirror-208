...
///////////////////////////////////////////////////////////////////////////////
    ...
    //   GET PIXEL STATUS                                                //
    ///////////////////////////////////////////////////////////////////////
    const uint16* CTA::R1::Event::getPixelStatus() const
    {
        assert(proto_object.num_pixels() != 0);
        return ADH::AnyArrayHelper::readAs<uint16>(proto_object.pixel_status());
    }

    uint16* CTA::R1::Event::getPixelStatus()
    {
        assert(proto_object.num_pixels() != 0);
    ...
    //   GET FIRST CELL ID                                               //
    ///////////////////////////////////////////////////////////////////////
    const uint32* CTA::R1::Event::getFirstCellId() const
    {
        assert(proto_object.num_pixels() != 0);
        return ADH::AnyArrayHelper::readAs<uint32>(proto_object.pixel_status());
    }

    uint32* CTA::R1::Event::getFirstCellId()
    {
        assert(proto_object.num_pixels() != 0);
