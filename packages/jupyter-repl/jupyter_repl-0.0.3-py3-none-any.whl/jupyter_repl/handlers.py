...
class JupyterREPLHandler(JupyterHandler):
    """JupyterREPLHandler"""
    ...
    def get(self):
        self.finish(json.dumps({
            "data": "This is /jupyter_repl/get_example endpoint!"
        }))
...
def setup_handlers(web_app):
    ...
    route_pattern = url_path_join(base_url, "jupyter_repl", "get_example")
    echo_pattern = url_path_join(base_url, "jupyter_repl", "echo")
    handlers = [
        (route_pattern, JupyterREPLHandler),
