...
class multi_factor_test(object):
    ...
    def multif_classification(self,allfactors,judgefunc,Price,quantiles,days,savedir,demean,index_price = None):
        ...
        for fc in list(allfactors):
            ...
            qreturn,clean_factor = sst.factor_ret_test_sheet(index_price,fc,res_df,Price,quantiles,days,savedir[0],demean)
        ...
        for nzfc in list(noise_factors_df):
            ...
            nz_qreturn,clean_factor = sst.factor_ret_test_sheet(index_price,nzfc,nz_res_df,Price,quantiles,days,savedir[1],demean)
            # 因子判别
    ...
    def batch_factors_test(self,allfactors,Price,quantiles,days,savedir,demean = False):
        returndict = {}
        sst = single_signal_test()
        for fc in list(allfactors):
            print(fc)
            res_df = sst.factor_prepare(allfactors,fc,quantiles)
            sst.factor_ret_test_sheet(fc,res_df,Price,quantiles,days,savedir,demean)
