...
class single_signal_test(object):
    ...
    def efficient_judge(self,qreturn,fc):
        ...
        if p_top10mean<=0.05 and p_lsret<=0.05:
            ...
            return True
        elif (p_top10mean/0.05 <= 0.1 or p_lsret/0.05 <= 0.1) and p_top10mean*p_lsret<0.0025 and p_top10mean<0.2 and p_lsret<0.2:
            print(fc+'勉强有用;头部10组平均收益一阶差分p值{},多空收益p值{}'.format(p_top10mean,p_lsret))
            return True            
        return False
    ...
    def short_judge(self,qreturn,fc):
        ...
        if p_top5>0.1 and p_bottom5<=0.05:
