...
from ..services.dexie_db import (
    get_claimable_offers,
    insert_new_offers,
    update_offers_rewards,
    update_offers_status,
    update_offers_ts_checked,
)
...
async def get_offers_with_claimable_rewards() -> List[Dict[str, Any]]:
    try:
        ...
        # update ts_check
        await update_offers_ts_checked(values)
        ...
        # update has_rewards
        num_has_rewards = await update_offers_rewards(result["offers"])
