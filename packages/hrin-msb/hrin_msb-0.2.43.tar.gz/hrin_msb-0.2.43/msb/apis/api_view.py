...
from msb.auth import (permissions, session, users, decorators)
...
TokenUser, SessionData, Permissions, require_permissions = (
	users.TokenUser, session.SessionData, permissions.Permissions, decorators.require_permissions
)
