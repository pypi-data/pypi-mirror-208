...
import os
from VSautomatic.TestCfgParse import CfgParse
...
# RedRatdate = restCfg.GetCfgInfo("RedRat","RedRat_dataset")
...
class RedRatHubCmdSetUp():
    ...
    def run(self):
        try:
            ...
            subprocess.Popen(log_file_path + '\RedRatHub-V4.27\RedRatHubCmd  ' + log_file_path + '\\RedRatHub-V4.27\\' + self.RedRatdate + '.xml')
