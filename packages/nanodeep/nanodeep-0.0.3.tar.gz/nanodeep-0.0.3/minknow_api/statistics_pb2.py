...
_ACQUISITIONOUTPUTSNAPSHOT = _descriptor.Descriptor(
  name='AcquisitionOutputSnapshot',
  full_name='minknow_api.statistics.AcquisitionOutputSnapshot',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='seconds', full_name='minknow_api.statistics.AcquisitionOutputSnapshot.seconds', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='yield_summary', full_name='minknow_api.statistics.AcquisitionOutputSnapshot.yield_summary', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STREAMACQUISITIONOUTPUTRESPONSE_FILTEREDSNAPSHOTS = _descriptor.Descriptor(
  name='FilteredSnapshots',
  full_name='minknow_api.statistics.StreamAcquisitionOutputResponse.FilteredSnapshots',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='filtering', full_name='minknow_api.statistics.StreamAcquisitionOutputResponse.FilteredSnapshots.filtering', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='snapshots', full_name='minknow_api.statistics.StreamAcquisitionOutputResponse.FilteredSnapshots.snapshots', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STREAMACQUISITIONOUTPUTRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='snapshots', full_name='minknow_api.statistics.StreamAcquisitionOutputResponse.snapshots', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_STREAMACQUISITIONOUTPUTRESPONSE_FILTEREDSNAPSHOTS, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_WRITEROUTPUTSNAPSHOT = _descriptor.Descriptor(
  name='WriterOutputSnapshot',
  full_name='minknow_api.statistics.WriterOutputSnapshot',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='seconds', full_name='minknow_api.statistics.WriterOutputSnapshot.seconds', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='writer_output', full_name='minknow_api.statistics.WriterOutputSnapshot.writer_output', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STREAMWRITEROUTPUTRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='snapshots', full_name='minknow_api.statistics.StreamWriterOutputResponse.snapshots', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BOXPLOTRESPONSE_BOXPLOTDATASET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='lower_full_width_half_maximum', full_name='minknow_api.statistics.BoxplotResponse.BoxplotDataset.lower_full_width_half_maximum', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mode', full_name='minknow_api.statistics.BoxplotResponse.BoxplotDataset.mode', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='upper_full_width_half_maximum', full_name='minknow_api.statistics.BoxplotResponse.BoxplotDataset.upper_full_width_half_maximum', index=8,
...
_ACQUISITIONOUTPUTSNAPSHOT.fields_by_name['yield_summary'].message_type = minknow__api_dot_acquisition__pb2._ACQUISITIONYIELDSUMMARY
_STREAMACQUISITIONOUTPUTRESPONSE_FILTEREDSNAPSHOTS.fields_by_name['filtering'].message_type = _ACQUISITIONOUTPUTKEY
_STREAMACQUISITIONOUTPUTRESPONSE_FILTEREDSNAPSHOTS.fields_by_name['snapshots'].message_type = _ACQUISITIONOUTPUTSNAPSHOT
_STREAMACQUISITIONOUTPUTRESPONSE_FILTEREDSNAPSHOTS.containing_type = _STREAMACQUISITIONOUTPUTRESPONSE
_STREAMACQUISITIONOUTPUTRESPONSE.fields_by_name['snapshots'].message_type = _STREAMACQUISITIONOUTPUTRESPONSE_FILTEREDSNAPSHOTS
_STREAMWRITEROUTPUTREQUEST.fields_by_name['data_selection'].message_type = _DATASELECTION
_WRITEROUTPUTSNAPSHOT.fields_by_name['writer_output'].message_type = minknow__api_dot_acquisition__pb2._ACQUISITIONWRITERSUMMARY
_STREAMWRITEROUTPUTRESPONSE.fields_by_name['snapshots'].message_type = _WRITEROUTPUTSNAPSHOT
...
DESCRIPTOR.message_types_by_name['AcquisitionOutputSnapshot'] = _ACQUISITIONOUTPUTSNAPSHOT
...
DESCRIPTOR.message_types_by_name['WriterOutputSnapshot'] = _WRITEROUTPUTSNAPSHOT
