...
class DeviceService(object):
    ...
    def clear_calibration(self, _message=None, _timeout=None, **kwargs):
        ...
        This is the same as setting the calibration to be the identity nanodeep (setting all offsets
    ...
    def get_calibration(self, _message=None, _timeout=None, **kwargs):
        ...
        To get a pA value from an ADC value the following nanodeep is applied::
