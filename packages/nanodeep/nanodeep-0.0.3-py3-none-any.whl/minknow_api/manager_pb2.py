...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[minknow__api_dot_rpc__options__pb2.DESCRIPTOR,minknow__api_dot_device__pb2.DESCRIPTOR,minknow__api_dot_instance__pb2.DESCRIPTOR,minknow__api_dot_protocol__settings__pb2.DESCRIPTOR,google_dot_protobuf_dot_timestamp__pb2.DESCRIPTOR,])

_SIMPLEPROTOCOLSTATE = _descriptor.EnumDescriptor(
  name='SimpleProtocolState',
  full_name='minknow_api.manager.SimpleProtocolState',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      name='NO_PROTOCOL_STATE', index=0, number=0,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='PROTOCOL_RUNNING', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='PROTOCOL_FINISHED_SUCCESSFULLY', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_SIMPLEPROTOCOLSTATE)

SimpleProtocolState = enum_type_wrapper.EnumTypeWrapper(_SIMPLEPROTOCOLSTATE)
_SIMULATEDDEVICETYPE = _descriptor.EnumDescriptor(
  name='SimulatedDeviceType',
  full_name='minknow_api.manager.SimulatedDeviceType',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      name='SIMULATED_AUTO', index=0, number=0,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SIMULATED_MINION', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SIMULATED_TRAXION', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SIMULATED_PROMETHION', index=3, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_sym_db.RegisterEnumDescriptor(_SIMULATEDDEVICETYPE)
...
_FLOWCELLPOSITION_RPCPORTS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='secure_grpc_web', full_name='minknow_api.manager.FlowCellPosition.RpcPorts.secure_grpc_web', index=1,
...
_FLOWCELLPOSITION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='protocol_state', full_name='minknow_api.manager.FlowCellPosition.protocol_state', index=8,
...
_BASECALLERAPIRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='secure_grpc_web', full_name='minknow_api.manager.BasecallerApiResponse.secure_grpc_web', index=1,
      number=3, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ADDSIMULATEDDEVICEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='type', full_name='minknow_api.manager.AddSimulatedDeviceRequest.type', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTSETTINGSFORPROTOCOLREQUEST = _descriptor.Descriptor(
  ...
  full_name='minknow_api.manager.ListSettingsForProtocolRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='identifier', full_name='minknow_api.manager.ListSettingsForProtocolRequest.identifier', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='components', full_name='minknow_api.manager.ListSettingsForProtocolRequest.components', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='flow_cell_connector', full_name='minknow_api.manager.ListSettingsForProtocolRequest.flow_cell_connector', index=2,
      number=3, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='protocol_identifier', full_name='minknow_api.manager.ListSettingsForProtocolRequest.protocol_identifier',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_LISTSETTINGSFORPROTOCOLRESPONSE_RUNOPTIONS = _descriptor.Descriptor(
  name='RunOptions',
  full_name='minknow_api.manager.ListSettingsForProtocolResponse.RunOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='run_length', full_name='minknow_api.manager.ListSettingsForProtocolResponse.RunOptions.run_length', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bias_voltage', full_name='minknow_api.manager.ListSettingsForProtocolResponse.RunOptions.bias_voltage', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='read_until_enabled', full_name='minknow_api.manager.ListSettingsForProtocolResponse.RunOptions.read_until_enabled', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='read_until_ref_file', full_name='minknow_api.manager.ListSettingsForProtocolResponse.RunOptions.read_until_ref_file', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='read_until_channels', full_name='minknow_api.manager.ListSettingsForProtocolResponse.RunOptions.read_until_channels', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='read_until_bed_file_enabled', full_name='minknow_api.manager.ListSettingsForProtocolResponse.RunOptions.read_until_bed_file_enabled', index=5,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='read_until_bed_file', full_name='minknow_api.manager.ListSettingsForProtocolResponse.RunOptions.read_until_bed_file', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='read_until_enrichment', full_name='minknow_api.manager.ListSettingsForProtocolResponse.RunOptions.read_until_enrichment', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='active_channel_selection', full_name='minknow_api.manager.ListSettingsForProtocolResponse.RunOptions.active_channel_selection', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mux_scan_period', full_name='minknow_api.manager.ListSettingsForProtocolResponse.RunOptions.mux_scan_period', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='group_change_period', full_name='minknow_api.manager.ListSettingsForProtocolResponse.RunOptions.group_change_period', index=10,
...
_LISTSETTINGSFORPROTOCOLRESPONSE_BASECALLING = _descriptor.Descriptor(
  name='Basecalling',
  full_name='minknow_api.manager.ListSettingsForProtocolResponse.Basecalling',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='basecalling_enabled', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Basecalling.basecalling_enabled', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='barcoding_enabled', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Basecalling.barcoding_enabled', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='barcoding_kits', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Basecalling.barcoding_kits', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='basecall_model', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Basecalling.basecall_model', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='trim_barcodes_enabled', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Basecalling.trim_barcodes_enabled', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='require_barcodes_both_ends', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Basecalling.require_barcodes_both_ends', index=5,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='detect_mid_strand_barcodes', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Basecalling.detect_mid_strand_barcodes', index=6,
      number=7, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='override_mid_barcoding_score', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Basecalling.override_mid_barcoding_score', index=7,
      number=8, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='override_rear_barcoding_score', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Basecalling.override_rear_barcoding_score', index=8,
      number=9, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='min_barcoding_score', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Basecalling.min_barcoding_score', index=9,
      number=10, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='min_barcoding_score_rear', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Basecalling.min_barcoding_score_rear', index=10,
      number=11, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='min_barcoding_score_mid', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Basecalling.min_barcoding_score_mid', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='alignment_enabled', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Basecalling.alignment_enabled', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='alignment_ref_file', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Basecalling.alignment_ref_file', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='alignment_bed_file_enabled', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Basecalling.alignment_bed_file_enabled', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='alignment_bed_file', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Basecalling.alignment_bed_file', index=15,
...
_LISTSETTINGSFORPROTOCOLRESPONSE_OUTPUT = _descriptor.Descriptor(
  name='Output',
  full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='output_location', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.output_location', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fast_q_enabled', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.fast_q_enabled', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fast_q_reads_per_file', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.fast_q_reads_per_file', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fast_q_data_compression', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.fast_q_data_compression', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fast_5_enabled', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.fast_5_enabled', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fast_5_reads_per_file', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.fast_5_reads_per_file', index=5,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fast_5_data_trace_table', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.fast_5_data_trace_table', index=6,
      number=7, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fast_5_data_move_table', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.fast_5_data_move_table', index=7,
      number=8, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fast_5_data_fast_q', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.fast_5_data_fast_q', index=8,
      number=9, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fast_5_data_raw', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.fast_5_data_raw', index=9,
      number=10, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fast_5_data_compression', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.fast_5_data_compression', index=10,
      number=11, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bam_enabled', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.bam_enabled', index=11,
      number=12, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='read_filtering_enabled', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.read_filtering_enabled', index=12,
      number=13, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='read_filtering_min_qscore', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.read_filtering_min_qscore', index=13,
      number=14, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='read_filtering_min_read_length', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.read_filtering_min_read_length', index=14,
      number=15, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='read_filtering_max_read_length', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.read_filtering_max_read_length', index=15,
      number=16, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bulk_file_enabled', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.bulk_file_enabled', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bulk_file_raw', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.bulk_file_raw', index=17,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bulk_file_events', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.bulk_file_events', index=18,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bulk_file_read_table', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.bulk_file_read_table', index=19,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bulk_file_raw_enabled', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.bulk_file_raw_enabled', index=20,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bulk_file_events_enabled', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.bulk_file_events_enabled', index=21,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bulk_file_read_table_enabled', full_name='minknow_api.manager.ListSettingsForProtocolResponse.Output.bulk_file_read_table_enabled', index=22,
...
_LISTSETTINGSFORPROTOCOLRESPONSE = _descriptor.Descriptor(
  ...
  full_name='minknow_api.manager.ListSettingsForProtocolResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='protocol', full_name='minknow_api.manager.ListSettingsForProtocolResponse.protocol', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='run_options', full_name='minknow_api.manager.ListSettingsForProtocolResponse.run_options', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='basecalling', full_name='minknow_api.manager.ListSettingsForProtocolResponse.basecalling', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='output', full_name='minknow_api.manager.ListSettingsForProtocolResponse.output', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='protocol_settings', full_name='minknow_api.manager.ListSettingsForProtocolResponse.protocol_settings', index=4,
...
_FLOWCELLPOSITION.fields_by_name['protocol_state'].enum_type = _SIMPLEPROTOCOLSTATE
...
_ADDSIMULATEDDEVICEREQUEST.fields_by_name['type'].enum_type = _SIMULATEDDEVICETYPE
...
_LISTSETTINGSFORPROTOCOLREQUEST.fields_by_name['components'].message_type = minknow__api_dot_protocol__settings__pb2._PROTOCOLIDENTIFIERCOMPONENTS
_LISTSETTINGSFORPROTOCOLREQUEST.fields_by_name['flow_cell_connector'].enum_type = minknow__api_dot_device__pb2._FLOWCELLCONNECTORTYPE
...
_LISTSETTINGSFORPROTOCOLRESPONSE_BASECALLING.fields_by_name['barcoding_kits'].message_type = minknow__api_dot_protocol__settings__pb2._PROTOCOLSETTING
...
_LISTSETTINGSFORPROTOCOLRESPONSE.fields_by_name['protocol'].message_type = minknow__api_dot_protocol__settings__pb2._PROTOCOLIDENTIFIERCOMPONENTS
...
DESCRIPTOR.enum_types_by_name['SimpleProtocolState'] = _SIMPLEPROTOCOLSTATE
DESCRIPTOR.enum_types_by_name['SimulatedDeviceType'] = _SIMULATEDDEVICETYPE
...
_MANAGERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=minknow__api_dot_instance__pb2._GETVERSIONINFORESPONSE,
    serialized_options=b'\220\002\001',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='minknow_api.manager.ManagerService.list_settings_for_protocol',
    index=27,
    containing_service=None,
