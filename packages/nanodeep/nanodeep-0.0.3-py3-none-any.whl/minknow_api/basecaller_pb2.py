...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[google_dot_protobuf_dot_timestamp__pb2.DESCRIPTOR,minknow__api_dot_analysis__configuration__pb2.DESCRIPTOR,minknow__api_dot_protocol__settings__pb2.DESCRIPTOR,minknow__api_dot_rpc__options__pb2.DESCRIPTOR,])
...
_POSTPROCESSINGPROVIDER = _descriptor.EnumDescriptor(
  name='PostProcessingProvider',
  full_name='minknow_api.basecaller.PostProcessingProvider',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_sym_db.RegisterEnumDescriptor(_POSTPROCESSINGPROVIDER)
...
_POSTPROCESSINGPROTOCOLINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='version', full_name='minknow_api.basecaller.PostProcessingProtocolInfo.version', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='description', full_name='minknow_api.basecaller.PostProcessingProtocolInfo.description', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='provider', full_name='minknow_api.basecaller.PostProcessingProtocolInfo.provider', index=4,
...
_SENDPINGREQUEST = _descriptor.Descriptor(
  ...
  full_name='minknow_api.basecaller.SendPingRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='ping_data', full_name='minknow_api.basecaller.SendPingRequest.ping_data', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SENDPINGRESPONSE = _descriptor.Descriptor(
  ...
  full_name='minknow_api.basecaller.SendPingResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_POSTPROCESSINGPROTOCOLINFO.fields_by_name['provider'].enum_type = _POSTPROCESSINGPROVIDER
...
DESCRIPTOR.enum_types_by_name['PostProcessingProvider'] = _POSTPROCESSINGPROVIDER
...
_BASECALLER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='send_ping',
    full_name='minknow_api.basecaller.Basecaller.send_ping',
    index=12,
    containing_service=None,
