...
class AcquisitionServiceServicer(object):
    ...
    def watch_for_status_change(self, request_iterator, context):
        ...
        to see how bi-directional streaming works in grpc, but essentially when calling this nanodeep the user will have
        ...
        The nanodeep will first return with the current status that MinKNOW is in. Every response thereafter will be a
