...
_STREAMTEMPERATUREREQUEST = _descriptor.Descriptor(
  ...
  full_name='minknow_api.promethion_device.StreamTemperatureRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='period_seconds', full_name='minknow_api.promethion_device.StreamTemperatureRequest.period_seconds', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETTEMPERATURERESPONSE = _descriptor.Descriptor(
  ...
  full_name='minknow_api.promethion_device.GetTemperatureResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='flowcell_temperature', full_name='minknow_api.promethion_device.GetTemperatureResponse.flowcell_temperature', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='chamber_temperature', full_name='minknow_api.promethion_device.GetTemperatureResponse.chamber_temperature', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pixel_block_temperature', full_name='minknow_api.promethion_device.GetTemperatureResponse.pixel_block_temperature', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='target_temperature', full_name='minknow_api.promethion_device.GetTemperatureResponse.target_temperature', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETTEMPERATURERESPONSE.fields_by_name['flowcell_temperature'].message_type = google_dot_protobuf_dot_wrappers__pb2._FLOATVALUE
_GETTEMPERATURERESPONSE.fields_by_name['chamber_temperature'].message_type = google_dot_protobuf_dot_wrappers__pb2._FLOATVALUE
_GETTEMPERATURERESPONSE.fields_by_name['pixel_block_temperature'].message_type = google_dot_protobuf_dot_wrappers__pb2._FLOATVALUE
...
_PROMETHIONDEVICESERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='minknow_api.promethion_device.PromethionDeviceService.stream_temperature',
    index=6,
    containing_service=None,
