...
class ExecutorBase:
        ...
        for name, param in arg_mapping.items():
            ...
            if type_name == "Input" and param._is_primitive_type:
                try:
                    ...
                    raise UserErrorException(
                        f"Parameter transition for {self._func.__name__!r} failed: For parameter {name!r}, "
    ...
    def _require_deps_injection(cls, func) -> bool:
        for parameter in inspect.signature(func).parameters.values():
            ...
            if getattr(annotation, "is_control", None) or getattr(annotation, "early_available", None):
                return True
        return False
