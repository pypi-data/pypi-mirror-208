...
class BasicShowroomVibrationAsset(sm.StateManager):
    states_map = {
        "Balanced": AssetStateCondition.OPTIMAL,
        "Unbalanced": AssetStateCondition.OPERATIONAL,
        "BaseLooseness": AssetStateCondition.OPERATIONAL,
        "Off": AssetStateCondition.UNDEFINED
    }
    ...
    def get_state(self, events) -> AssetState:
        ...
        return AssetState(events=ids,
                          ...
                          condition=BasicShowroomVibrationAsset.states_map.get(event["event"],
                                                                               AssetStateCondition.UNDEFINED),
...
@ray.remote
class RayBasicShowroomVibrationAsset(BasicShowroomVibrationAsset):
    def __init__(self, asset_id, tasks, events_and_states_dataset, backup_collection_name, notifications_topic,
                 reports_topic, credentials_str, log_level=logging.INFO):
