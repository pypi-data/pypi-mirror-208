    ...
    async def transaction(self):
        ...
        try:
            ...
            await self.run_in_executor(
                functools.partial(tx.__exit__, None, None, None) # type: ignore
            )
        except Exception:
            # TODO: Raises weird exceptions (IndexError: pop from empty list)
            #await self.run_in_executor(
            #    functools.partial(tx.__exit__, type(e), e, sys.exc_info()) # type: ignore
            #)
            raise
