...
class KalmanFilter_3_2_3():
    ...
    """
    @typing.overload
    def K(self) -> numpy.ndarray[numpy.float64, _Shape[3, 3]]: 
        """
        Returns the steady-state Kalman gain matrix K.
    ...
    @typing.overload
    def K(self, i: int, j: int) -> float: ...
    def __init__(self, plant: wpimath._controls._controls.system.LinearSystem_3_2_3, stateStdDevs: typing.Tuple[float, float, float], measurementStdDevs: typing.Tuple[float, float, float], dt: seconds) -> None: 
        """
        Constructs a state-space observer with the given plant.
        ...
        :param dt:                 Nominal discretization timestep.
                                   @throws std::invalid_argument If the system is unobservable.
        """
    def correct(self, u: numpy.ndarray[numpy.float64, _Shape[2, 1]], y: numpy.ndarray[numpy.float64, _Shape[3, 1]]) -> None: 
        """
        Correct the state estimate x-hat using the measurements in y.
