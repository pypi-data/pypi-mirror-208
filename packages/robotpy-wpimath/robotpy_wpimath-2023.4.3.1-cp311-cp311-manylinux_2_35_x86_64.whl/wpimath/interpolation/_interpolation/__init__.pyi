...
class TimeInterpolatablePose3dBuffer():
    ...
    def __init__(self, historySize: seconds) -> None: 
        ...
        """
    @typing.overload
    def __init__(self, historySize: seconds, func: typing.Callable[[wpimath.geometry._geometry.Pose3d, wpimath.geometry._geometry.Pose3d, float], wpimath.geometry._geometry.Pose3d]) -> None: ...
    def addSample(self, time: seconds, sample: wpimath.geometry._geometry.Pose3d) -> None: 
        """
        Add a sample to the buffer.
    ...
    def clear(self) -> None: 
        ...
        Clear all old samples.
        """
    def getInternalBuffer(self) -> typing.List[typing.Tuple[seconds, wpimath.geometry._geometry.Pose3d]]: 
        """
        Grant access to the internal sample buffer. Used in Pose Estimation to
        replay odometry inputs stored within this buffer.
        """
    def sample(self, time: seconds) -> typing.Optional[wpimath.geometry._geometry.Pose3d]: 
        """
        Sample the buffer at the given time. If the buffer is empty, an empty
        optional is returned.
...
class TimeInterpolatableRotation3dBuffer():
    ...
    def __init__(self, historySize: seconds) -> None: 
        ...
        """
    @typing.overload
    def __init__(self, historySize: seconds, func: typing.Callable[[wpimath.geometry._geometry.Rotation3d, wpimath.geometry._geometry.Rotation3d, float], wpimath.geometry._geometry.Rotation3d]) -> None: ...
    def addSample(self, time: seconds, sample: wpimath.geometry._geometry.Rotation3d) -> None: 
        """
        Add a sample to the buffer.
    ...
    def clear(self) -> None: 
        ...
        Clear all old samples.
        """
    def getInternalBuffer(self) -> typing.List[typing.Tuple[seconds, wpimath.geometry._geometry.Rotation3d]]: 
        """
        Grant access to the internal sample buffer. Used in Pose Estimation to
        replay odometry inputs stored within this buffer.
        """
    def sample(self, time: seconds) -> typing.Optional[wpimath.geometry._geometry.Rotation3d]: 
        """
        Sample the buffer at the given time. If the buffer is empty, an empty
        optional is returned.
...
class TimeInterpolatableTranslation2dBuffer():
    ...
    def __init__(self, historySize: seconds) -> None: 
        ...
        """
    @typing.overload
    def __init__(self, historySize: seconds, func: typing.Callable[[wpimath.geometry._geometry.Translation2d, wpimath.geometry._geometry.Translation2d, float], wpimath.geometry._geometry.Translation2d]) -> None: ...
    def addSample(self, time: seconds, sample: wpimath.geometry._geometry.Translation2d) -> None: 
        """
        Add a sample to the buffer.
    ...
    def clear(self) -> None: 
        ...
        Clear all old samples.
        """
    def getInternalBuffer(self) -> typing.List[typing.Tuple[seconds, wpimath.geometry._geometry.Translation2d]]: 
        """
        Grant access to the internal sample buffer. Used in Pose Estimation to
        replay odometry inputs stored within this buffer.
        """
    def sample(self, time: seconds) -> typing.Optional[wpimath.geometry._geometry.Translation2d]: 
        """
        Sample the buffer at the given time. If the buffer is empty, an empty
        optional is returned.
...
class TimeInterpolatableTranslation3dBuffer():
    ...
    def __init__(self, historySize: seconds) -> None: 
        ...
        """
    @typing.overload
    def __init__(self, historySize: seconds, func: typing.Callable[[wpimath.geometry._geometry.Translation3d, wpimath.geometry._geometry.Translation3d, float], wpimath.geometry._geometry.Translation3d]) -> None: ...
    def addSample(self, time: seconds, sample: wpimath.geometry._geometry.Translation3d) -> None: 
        """
        Add a sample to the buffer.
    ...
    def clear(self) -> None: 
        ...
        Clear all old samples.
        """
    def getInternalBuffer(self) -> typing.List[typing.Tuple[seconds, wpimath.geometry._geometry.Translation3d]]: 
        """
        Grant access to the internal sample buffer. Used in Pose Estimation to
        replay odometry inputs stored within this buffer.
        """
    def sample(self, time: seconds) -> typing.Optional[wpimath.geometry._geometry.Translation3d]: 
        """
        Sample the buffer at the given time. If the buffer is empty, an empty
        optional is returned.
