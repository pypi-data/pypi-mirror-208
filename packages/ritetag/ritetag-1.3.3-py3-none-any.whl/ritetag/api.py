...
class RiteTagApi:
    ...
    @api_call
    def company_logo(self, domain, generateFallbackLogo=False, squareLogoSize=256, squareLogoBackground='original'):
        # type: (str, bool) -> str
        """
        Deprecated
        ...
        response = self._get_request('/v2/company-insights/logo', {'domain': domain, 'generateFallbackLogo': gen, 'squareLogoSize': squareLogoSize, 'squareLogoBackground': squareLogoBackground})
