...
class cockroachdbConnectionManager(SQLConnectionManager):
    ...
    def open(cls, connection):
        ...
        # psycopg doesn't support search_path officially,
        ...
        retryable_exceptions = [
            # OperationalError is subclassed by all psycopg Connection Exceptions and it's raised
            # by generic connection timeouts without an error code. This is a limitation of
            # psycopg which doesn't provide subclasses for errors without a SQLSTATE error code.
            # The limitation has been known for a while and there are no efforts to tackle it.
            # See: https://github.com/psycopg/psycopg/issues/682
