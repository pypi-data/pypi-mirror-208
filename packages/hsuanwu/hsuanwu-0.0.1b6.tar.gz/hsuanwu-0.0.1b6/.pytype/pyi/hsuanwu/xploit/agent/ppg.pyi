...
class PPG(hsuanwu.xploit.agent.base.BaseAgent):
    ...
    training: bool
    vf_coef: float
    def __init__(self, observation_space, action_space, device: str, feature_dim: int, lr: float = ..., eps: float = ..., hidden_dim: int = ..., clip_range: float = ..., clip_range_vf: float = ..., vf_coef: float = ..., ent_coef: float = ..., aug_coef: float = ..., max_grad_norm: float = ..., policy_epochs: int = ..., aux_epochs: int = ..., kl_coef: float = ..., num_aux_mini_batch: int = ..., num_aux_grad_accum: int = ..., network_init_method: str = ...) -> None: ...
