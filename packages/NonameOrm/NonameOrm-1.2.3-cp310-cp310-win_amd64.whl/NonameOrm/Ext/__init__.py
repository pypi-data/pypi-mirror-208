...
from NonameOrm.Ext.PageAble import _Page
...
supportTypeMap: TDict[str, type(Enum)] = {
...
async def _updateModelAst(moduleAst: ast.Module, tableName: str, filePath: str, colAnnounceList: List[dict]):
    ...
    :return:
    """
    colAssignMap: TDict[str, ast.Assign] = _getColAssignFromAstModule(moduleAst)
...
def _getColAssignFromAstModule(module: ast.Module) -> TDict[str, ast.Assign]:
    """
    从
    ...
    :return:
    """
    colAssignMap: TDict[str, ast.Assign] = dict()
