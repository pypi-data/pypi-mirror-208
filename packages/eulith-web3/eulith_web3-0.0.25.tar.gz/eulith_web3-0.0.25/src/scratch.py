...
MAIN = 'https://eth-main.eulithrpc.com/v0'
REFRESH = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NksifQ.eyJzdWIiOiJsaWJ0ZXN0IiwiZXhwIjoxODQ0Njc0NDA3MzcwOTU1MTYxNSwic291cmNlX2hhc2giOiIqIiwic2NvcGUiOiJBUElSZWZyZXNoIn0.G87Tv9LwLH8SRgjlVKIAPk1pdavVS0xwz3fuB7lxP0Et-pPM7ojQkjC1zlC7zWYUdh9p3GvwX_ROfgSPJsw-Qhw'
...
if __name__ == '__main__':
    ...
    r = pc.swap(
        weth,
        PendleMarketSymbol.PT,
        1,
        0.01,
        ew3.to_checksum_address('0xC374f7eC85F8C7DE3207a10bB1978bA104bdA3B2'))

    at = weth.approve_float(r.approve_address, 1, {
        'from': wallet.address,
        'gas': 100000
    })
    ew3.eth.send_transaction(at)

    ew3.eth.send_transaction(r.tx)

    buy_balance = r.buy_token.balance_of_float(wallet.address)
    print(buy_balance)
