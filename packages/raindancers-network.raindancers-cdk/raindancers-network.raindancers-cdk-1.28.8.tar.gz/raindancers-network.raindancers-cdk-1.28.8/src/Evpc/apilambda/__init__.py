...
class PythonApiIngestToS3(
    ...
    def __init__(
        ...
        *,
        ...
        kms: typing.Optional[typing.Sequence[_aws_cdk_aws_kms_ceddda9d.Key]] = None,
...
class PythonApiIngestToS3Props:
    ...
    @builtins.property
    def kms(self) -> typing.Optional[typing.List[_aws_cdk_aws_kms_ceddda9d.Key]]:
        '''
        :stability: experimental
        '''
        result = self._values.get("kms")
        return typing.cast(typing.Optional[typing.List[_aws_cdk_aws_kms_ceddda9d.Key]], result)
