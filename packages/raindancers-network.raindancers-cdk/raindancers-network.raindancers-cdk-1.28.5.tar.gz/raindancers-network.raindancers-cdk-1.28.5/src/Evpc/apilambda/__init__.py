...
class PythonApiIngestToS3(
    ...
    def __init__(
        ...
        *,
        ...
        secrets: typing.Optional[typing.Sequence[aws_cdk.aws_secretsmanager.Secret]] = None,
    ) -> None:
        '''
        :param scope: -
        :param id: -
...
class PythonApiIngestToS3Props:
    ...
    def secrets(
        self,
    ) -> typing.Optional[typing.List[aws_cdk.aws_secretsmanager.Secret]]:
        '''
        :stability: experimental
        '''
        result = self._values.get("secrets")
        return typing.cast(typing.Optional[typing.List[aws_cdk.aws_secretsmanager.Secret]], result)
