...
# CSV 파일의 경로를 구성합니다.
data_path = os.path.join(current_dir, 'data', 'busan.csv')

# 이제 data_path는 CSV 파일의 유효한 경로를 포함해야 합니다.

font_path = os.path.join(current_dir, 'data', 'NanumBarunGothicLight.ttf')
