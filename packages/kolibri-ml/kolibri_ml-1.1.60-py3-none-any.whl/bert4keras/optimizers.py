...
class Adam(keras.optimizers.Optimizer):
    """Redefine the Adam optimizer to facilitate the derivation of new optimizers
    （tensorflow的optimizer_v2）
    """
    def __init__(
        self,
        learning_rate=0.001,
...
class AdaFactorBase(keras.optimizers.Optimizer):
    """AdaFactor optimizer (base class）
    paper：https://arxiv.org/abs/1804.04235
    reference implementation：https://github.com/tensorflow/mesh/blob/master/mesh_tensorflow/optimize.py
    """
    def __init__(
        self,
...
class AdaFactorV1(AdaFactorBase):
    """AdaFactor optimizer (pure Keras version)
    paper：https://arxiv.org/abs/1804.04235
    ref implementation：https://github.com/tensorflow/mesh/blob/master/mesh_tensorflow/optimize.py
    """
