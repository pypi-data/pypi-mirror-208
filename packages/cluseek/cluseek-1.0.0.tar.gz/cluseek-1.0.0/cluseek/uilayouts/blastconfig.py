...
class Ui_BlastConfig(object):
    def setupUi(self, BlastConfig):
        ...
        BlastConfig.resize(470, 450)
        BlastConfig.setMinimumSize(QSize(0, 450))
        ...
        self.gridLayout.addWidget(self.entrez_ledit, 2, 2, 1, 3)
        ...
        self.gridLayout.addWidget(self.matrix_combo, 6, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.gapcost_combo, 7, 2, 1, 3)
        ...
        self.gridLayout.addWidget(self.maxhits_lbl, 11, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.filter_chk, 16, 2, 1, 3)
        ...
        self.gridLayout.addWidget(self.mask_chk, 17, 2, 1, 3)
