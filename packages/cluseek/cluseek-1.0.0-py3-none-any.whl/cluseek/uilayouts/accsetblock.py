...
class Ui_AccsetBlock(object):
    def setupUi(self, AccsetBlock):
        ...
        self.btn_view = QPushButton(AccsetBlock)
        self.btn_view.setObjectName(u"btn_view")
        self.btn_view.setMinimumSize(QSize(50, 20))
        self.btn_view.setMaximumSize(QSize(50, 30))

        self.lay_accsetblock.addWidget(self.btn_view)
    ...
    def retranslateUi(self, AccsetBlock):
        ...
        self.btn_view.setText(QCoreApplication.translate("AccsetBlock", u"View", None))
