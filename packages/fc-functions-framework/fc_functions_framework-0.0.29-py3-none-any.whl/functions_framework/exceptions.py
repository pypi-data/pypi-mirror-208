...
class MissingFunctionContextENV(FunctionsFrameworkException):
    pass
...
class MissingOFFunctionInputENV(FunctionsFrameworkException):
    pass


class InvalidFuncContextInputType(FunctionsFrameworkException):
    pass


class InvalidFuncContextOutputType(FunctionsFrameworkException):
    pass
