...
from fastforward.generation.strategy.beam.beam_search import BeamSearch
from fastforward.generation.strategy.beam.beam_search_scorer import BeamSearchScorer


class BeamGenModeStrategy(SearchStrategy):
    ...
    def handle(self, config: GenerationConfig, **model_kwargs):
        ...
        return BeamSearch(self.generation_step, config).beam_search(
            input_ids,
            BeamSearchScorer(config),
