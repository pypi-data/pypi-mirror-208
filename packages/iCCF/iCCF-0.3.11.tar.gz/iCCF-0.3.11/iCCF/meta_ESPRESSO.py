...
def _dowork(args, debug=False):
    ...
    # print('y:', y.dtype)
    # print('ye:', ye.dtype)
    # print('blaze:', blaze.dtype)
    # print('quality:', quality.dtype)
    # print('rvarray:', rvarray.dtype)
    # print('mask_wave:', mask_wave.dtype)
    # print('mask_contrast:', mask_contrast.dtype)
...
def compare_ccfs(ccf_file1, ccf_file2):
    import numpy.testing as npt
    hdu1 = fits.open(ccf_file1)
    hdu2 = fits.open(ccf_file2)
    try:
        npt.assert_allclose(hdu1[1].data, hdu2[1].data)
    except AssertionError as e:
        print('compare hdu[1].data')
        print('\n'.join([f'\t{line}' for line in str(e).split('\n')]))

    print()
    try:
        npt.assert_allclose(hdu1[2].data, hdu2[2].data)
    except AssertionError as e:
        print('compare hdu[2].data')
        print('\n'.join([f'\t{line}' for line in str(e).split('\n')]))
