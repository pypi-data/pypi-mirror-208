...
class AppsIdBody(object):
    ...
    def plugin_arguments(self) -> 'dict(str, str)':
        """Gets the plugin_arguments of this AppsIdBody.  # noqa: E501


        :return: The plugin_arguments of this AppsIdBody.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def plugin_arguments(self, plugin_arguments: 'dict(str, str)'):
        """Sets the plugin_arguments of this AppsIdBody.


        :param plugin_arguments: The plugin_arguments of this AppsIdBody.  # noqa: E501
        :type: dict(str, str)
        """
