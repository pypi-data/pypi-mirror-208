...
class V1ProjectSettings(object):
    ...
    """
    swagger_types = {'same_compute_on_resume': 'bool'}

    attribute_map = {'same_compute_on_resume': 'sameComputeOnResume'}

    def __init__(self, same_compute_on_resume: 'bool' = None):  # noqa: E501
