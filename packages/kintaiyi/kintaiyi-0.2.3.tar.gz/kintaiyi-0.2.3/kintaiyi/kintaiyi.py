...
import config
import jieqi
from config import num, su, gong, gong1, gong2, gong3, gua, nayin_wuxing, wuxing_relation_2, jc, jc1, tyjc, skyeyes_dict, multi_key_dict_get, jiazi, num2gong, Ganzhiwuxing, di_zhi, gangzhi
...
if __name__ == '__main__':
    ...
    print(Taiyi(658,5,31,0,14).pan(0,0))
