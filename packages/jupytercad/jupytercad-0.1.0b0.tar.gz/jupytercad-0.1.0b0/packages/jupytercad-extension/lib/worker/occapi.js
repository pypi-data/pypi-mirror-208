...
const Box = operatorCache('Box', _Box);
const Cylinder = operatorCache('Cylinder', _Cylinder);
const Sphere = operatorCache('Sphere', _Sphere);
const Cone = operatorCache('Cone', _Cone);
const Torus = operatorCache('Torus', _Torus);
const SketchObject = operatorCache('SketchObject', _SketchObject);
