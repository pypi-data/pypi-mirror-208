...
def validate_non_negative_integer_or_minus_1(string: str) -> str:
    """
    :param string: A string
    :return: The same string, if it represents a decimal integer or -1
    :raises CertoraUserInputError if the string does not represent a non-negative decimal integer or -1
    """
    if string == '-1':
        return string
    if not string.isnumeric():
