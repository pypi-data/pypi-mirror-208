...
class JSONParser(IncrementalParser):
    ...
    def __init__(self, allow_outer_list: bool = True, allow_empty: bool = True, allow_empty_children: bool = True):
        super().__init__()
    ...
    def _append(self, char: Union[str, SpecialToken]) -> bool:
        ...
        if done:
            ...
            if (not sub_parsed) and not self._allow_empty:
                raise ParseFailure("Got empty object or array. If this is expected set allow_empty=True")
