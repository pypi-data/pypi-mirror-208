...
class DataTypes(Message):
  ...
  @property
  def tx_power_level_oneof(self) -> Union[bool, None, int]: ...
  ...
  @property
  def class_of_device_oneof(self) -> Union[bool, None, int]: ...
  ...
  @property
  def advertising_interval_oneof(self) -> Union[bool, None, int]: ...
