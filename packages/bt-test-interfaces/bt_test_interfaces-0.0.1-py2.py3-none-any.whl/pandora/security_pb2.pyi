...
class PairingEventAnswer(Message):
  ...
  @property
  def answer(self) -> Union[bool, bytes, int, None]: ...
...
class SecureRequest(Message):
  ...
  @property
  def level(self) -> Union[SecurityLevel, None, LESecurityLevel]: ...
