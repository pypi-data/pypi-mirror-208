...
class Consumer(object):
    ...
    def __init__(self, amqp_url, exchange, routing_key, callback):
        """Create a new instance of the consumer class, passing in the AMQP
        URL used to connect to RabbitMQ.

        :param str amqp_url: The AMQP url to connect with
        :param str exchange: The exchange to bind to
        :param str queue: The queue to bind to
        :param str routing_key: The routing key to bind with
        :param callable callback: The callback to call when a message is received
...
class ReconnectingConsumer(object):
    ...
    def __init__(self, amqp_url, exchange, routing_key, callback):
        ...
        self._routing_key = routing_key
        self._callback = callback
        self._consumer = Consumer(self._amqp_url, exchange, routing_key, callback)
    ...
    def _maybe_reconnect(self):
        if self._consumer.should_reconnect:
            ...
            self._consumer = Consumer(self._amqp_url, self._exchange, self._routing_key, self._callback)
...
class Publisher(object):
    ...
    def publish(self, message):
        ...
        if self._channel is None or not self._channel.is_open:
            return
        properties = pika.BasicProperties(app_id='gwopsclinet-publisher',
