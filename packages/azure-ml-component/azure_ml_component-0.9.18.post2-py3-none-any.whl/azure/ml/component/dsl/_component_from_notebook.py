...
from azure.ml.component._core._types import Input, Output, String, \
...
def is_dsl_component_expr(ast_obj):
    ...
    return isinstance(ast_obj, ast.Expr) and\
        ...
        (ast_obj.value.func.attr == 'component' or ast_obj.value.func.attr == '_component'
         or ast_obj.value.func.attr == 'module' or ast_obj.value.func.attr == 'command_component')
