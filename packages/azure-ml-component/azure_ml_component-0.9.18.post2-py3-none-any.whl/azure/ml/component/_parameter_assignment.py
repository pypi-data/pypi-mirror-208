...
from ._util._utils import _flatten_pipeline_parameters, _get_parameter_static_value
...
class _ParameterAssignment:
    ...
    def resolve(str_value, init_params_dict, print_warning=True):
        ...
        values_dict = {part.str: values_dict[part.str] for part in parts
                       if part.type in [PIPELINE_PARAMETER, CONCATENATE]
                       and part.str in values_dict}
    ...
    def get_value_with_pipeline_parameters(self, pipeline_parameters=None, next_pipeline_parameters=None):
        """
        ...
        for part in flattened_assignment.assignments:
            ...
            if part.type == self.LITERAL or part.str not in flattened_assignment.assignments_values_dict:
                ...
                part_value = _get_parameter_static_value(pipeline_parameters[part.str], next_pipeline_parameters) \
                    if part.str in pipeline_parameters else flattened_assignment.assignments_values_dict[part.str]
