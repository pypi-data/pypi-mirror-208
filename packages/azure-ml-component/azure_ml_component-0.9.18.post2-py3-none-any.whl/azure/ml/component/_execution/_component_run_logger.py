...
class Logger(object):
    ...
    def __new__(cls, *args, **kwargs):
        ...
        with cls._instance_lock:
            if cls._instance is None:
                ...
                add_method_to_class(cls, "isatty", sys.stdout.isatty)  # other sdk will use sys.stdout.isatty function.
    ...
    def print_to_terminal(self, message):
        ...
        try:
            ...
            print('Print message to terminal failed, error: {0}, message={1}'.format(e, message))
