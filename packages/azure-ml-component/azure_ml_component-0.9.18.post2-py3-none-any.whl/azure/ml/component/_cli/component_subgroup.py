...
class ComponentSubGroup(abstract_subgroup.AbstractSubGroup):
    ...
    def _command_create(self):
        ...
        arguments = [
            ...
            argument.Argument(
                "skip_if_no_change", "--skip-if-no-change", "", action="store_true", required=False,
                help="Skip to register the component if the component is not modified "
                     "relative to default version of the component."),
            COMPONENT_SET
        ]
        ...
        examples = [
            ...
            Example(
                ...
                text='az ml component create --file=path/to/component_spec.yaml --registry "registry_name"',
            ),
            Example(
    ...
    def _command_list(self):
        ...
        examples = [
            ...
            Example(
                ...
                text='az ml component list --name "component_name"',
            ),
            Example(
                name="List registry component",
                text='az ml component list --registry "registry_name"',
            )
        ]
    ...
    def _command_show(self):
        ...
        examples = [
            Example(
                ...
                text='az ml component show --name "component_name"',
            ),
            Example(
                name="Show detail information of a component's specific version",
                text='az ml component show --name "component_name" --version 0.0.1',
            ),
            Example(
                name="Show detail information of a registry component's default version ",
                text='az ml component show --name "component_name" --registry "registry_name"',
            )
        ]
    ...
    def _command_restore(self):
        ...
        arguments = [
            ...
            argument.Argument(
                "registry", "--registry", "", required=False,
                help="If specified, restore registry component.")
        ]

        examples = [
            Example(
                name="Restore a component",
                text='az ml component restore --name "component_name"',
            ),
            Example(
                name="Restore a registry component",
                text='az ml component restore --name "component_name" --registry "registry_name"',
            )
        ]
    ...
    def _command_archive(self):
        ...
        arguments = [
            ...
            argument.Argument(
                "registry", "--registry", "", required=False,
                help="If specified, archive registry component.")
        ]

        examples = [
            Example(
                name="Archive a component",
                text='az ml component archive --name "component_name"',
            ),
            Example(
                name="Archive a registry component",
                text='az ml component archive --name "component_name" --registry "registry_name"',
            )
        ]
    ...
    def _command_update(self):
        ...
        arguments = [
            ...
            argument.Argument(
                "registry", "--registry", "", required=False,
                help="If specified, update registry component.")
        ]

        examples = [
            Example(
                name="Set default version of a component",
                text='az ml component update --name "component_name" --version 0.0.1 --label default',
            ),
            Example(
                name="Set default version of a registry component",
                text='az ml component update --name "component_name" --version 0.0.1 --label default'
    ...
    def _command_download(self):
        ...
        examples = [
            Example(
                ...
                text='az ml component download --name "component_name"',
            ),
            Example(
                name="Download component to a specific directory",
                text='az ml component download --name "component_name" --target path/to/save',
            ),
            Example(
                name="Download component of specific version",
                text='az ml component download --name "component_name" --version 0.0.1',
            )
        ]
