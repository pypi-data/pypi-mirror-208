...
from FLite.datasets.femnist.preprocess.data_to_json import data_to_json
from FLite.datasets.femnist.preprocess.get_file_dirs import get_file_dir
from FLite.datasets.femnist.preprocess.get_hashes import get_hash
from FLite.datasets.femnist.preprocess.group_by_writer import group_by_writer
from FLite.datasets.femnist.preprocess.match_hashes import match_hash
...
class Femnist(BaseDataset):
    ...
    def download_raw_file_and_extract(self):
        ...
        extract_archive(class_path)
        extract_archive(write_path)
