...
from FLite.server import strategies
...
class BaseServer(object):
    ...
    Args:
        conf (omegaconf.dictconfig.DictConfig): Configurations of FLite.
    ...
    Example:
        >>> from FLite.server import BaseServer
