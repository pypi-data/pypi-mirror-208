...
from FLite.heterogeneous_simulation.mobilephone_speed_hetero import MOBILE_SPEED_HETERO
from FLite.datasets.utils.splitdata_simulation import equal_division
...
def sample_real_ratio(num_values):
    value_pool = list(MOBILE_SPEED_HETERO.values())
