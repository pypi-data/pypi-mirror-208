...
Status = _reflection.GeneratedProtocolMessageType(
    ...
    {
        "DESCRIPTOR": _STATUS,
        "__module__": "FLite.protobuf.common_pb2"
        # @@protoc_insertion_point(class_scope:FLite.protobuf.Status)
    },
)
_sym_db.RegisterMessage(Status)

TaskMetric = _reflection.GeneratedProtocolMessageType(
    "TaskMetric",
    (_message.Message,),
    {
        "DESCRIPTOR": _TASKMETRIC,
        "__module__": "FLite.protobuf.common_pb2"
        # @@protoc_insertion_point(class_scope:FLite.protobuf.TaskMetric)
    },
)
_sym_db.RegisterMessage(TaskMetric)

RoundMetric = _reflection.GeneratedProtocolMessageType(
    "RoundMetric",
    (_message.Message,),
    {
        "DESCRIPTOR": _ROUNDMETRIC,
        "__module__": "FLite.protobuf.common_pb2"
        # @@protoc_insertion_point(class_scope:FLite.protobuf.RoundMetric)
    },
)
_sym_db.RegisterMessage(RoundMetric)

ClientMetric = _reflection.GeneratedProtocolMessageType(
    "ClientMetric",
    (_message.Message,),
    {
        "DESCRIPTOR": _CLIENTMETRIC,
        "__module__": "FLite.protobuf.common_pb2"
        # @@protoc_insertion_point(class_scope:FLite.protobuf.ClientMetric)
    },
)
