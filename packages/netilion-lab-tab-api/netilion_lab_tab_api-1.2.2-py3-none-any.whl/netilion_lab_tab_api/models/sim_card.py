...
class SimCard(object):
    ...
    def __init__(self, status=None):  # noqa: E501
        """SimCard - a model defined in Swagger"""  # noqa: E501
        self._status = None
    ...
    @property
    def status(self):
        """Gets the status of this SimCard.  # noqa: E501

        possible values are active and inactive  # noqa: E501

        :return: The status of this SimCard.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this SimCard.

        possible values are active and inactive  # noqa: E501

        :param status: The status of this SimCard.  # noqa: E501
        :type: str
        """
