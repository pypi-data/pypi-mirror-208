...
class Config(object):
    ...
    def has_enabled_by_minimal_backend_version(
        ...
        current_backend_version: Optional[Tuple[int, int, int]],
    ) -> Tuple[bool, str]:
        minimal_backend_version = self[minimal_backend_version_key]
        min_version = parse_version_number(minimal_backend_version)
    ...
    def has_fallback_to_offline_enabled(
        self, current_backend_version: Optional[Tuple[int, int, int]]
    ) -> Tuple[bool, str]:
