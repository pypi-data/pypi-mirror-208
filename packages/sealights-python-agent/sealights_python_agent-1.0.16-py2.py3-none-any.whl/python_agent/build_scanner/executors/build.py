...
class Build(object):
    def __init__(self, config_data):
        ...
        self.agent_manager = AgentEventsManager(config_data=config_data, agent_type=AGENT_TYPE_BUILD_SCANNER, agent_id=None)
    ...
    def execute(self):
        ...
        try:
            build_scanner.main(config_data=self.config_data, workspacepath=self.workspacepath, include=self.include,exclude=self.exclude)
