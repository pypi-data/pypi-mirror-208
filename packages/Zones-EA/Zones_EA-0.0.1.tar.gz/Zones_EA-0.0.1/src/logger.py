...
class LoggerManager:
    ...
    def get_logger(category):
        ...
        if logging_enabled:
            ...
            def logging_func(level, msg, args, exc_info=None, extra=None, stack_info=False, stacklevel_=1):
                if isinstance(msg, Callable):
                    msg = msg()
                original_log(level, msg, args, exc_info, extra, stack_info, stacklevel_)
