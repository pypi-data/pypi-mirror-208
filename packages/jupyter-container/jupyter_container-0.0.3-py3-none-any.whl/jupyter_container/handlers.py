...
class JupyterContainerHandler(JupyterHandler):
    """JupyterContainerHandler"""
    ...
    def get(self):
        self.finish(json.dumps({
            "data": "This is /jupyter_container/get_example endpoint!"
        }))
...
def setup_handlers(web_app):
    ...
    route_pattern = url_path_join(base_url, "jupyter_container", "get_example")
    echo_pattern = url_path_join(base_url, "jupyter_container", "echo")
    handlers = [
        (route_pattern, JupyterContainerHandler),
