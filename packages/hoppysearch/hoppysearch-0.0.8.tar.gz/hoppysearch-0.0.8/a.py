...
# try:
#     response = hs.index(documents, optionals)
...
# try:
#     response = hs.search(query, optionals)
#     print(response)
# except ApiException as e:
#     print("Exception: %s\n" % e)
...
# try:
#     response = hs.lucene_search(luceneQuery, optionals)
#     print(response)
# except ApiException as e:
#     print("Exception: %s\n" % e)
...
# # without optionals
# try:
#     response = hs.lucene_search(luceneQuery)
#     print(response)
# except ApiException as e:
#     print("Exception: %s\n" % e)
...
# try:
#     response = hs.delete(hs_guid, optionals)
#     print(response)
# except ApiException as e:
#     print("Exception: %s\n" % e)
