...
def help():
    ans=''' 
    intermediate code generator(postfix prefix) : print(arrays.icg())
    LR0 : print(arrays.lr0())
    predictive parser : print(arrays.pp())
    Regular Expression to NFA : print(arrays.rtn())
    NFA to DFA : print(arrays.ntd())
    First and Follow : print(arrays.faf())
    Lexical Analyser : print(arrays.la())
    Shift Reduce Parsing : print(arrays.srp())
    Leading and Trailing : print(arrays.lat())
    Intermediate Code Generator : print(arrays.qti())
    Simple Code Generator : print(arrays.scg())
    Left recursion : print(arrays.leftrec())
    Left factoring : print(arrays.leftfact())
    DAG : print(arrays.dag())
    ''' 
    return(ans)
def all():
    ans=''' 
...
def saveicg():
    import os
    import sys
    with open(os.path.join(sys.path[0], "postfixprefix.py"), "w") as f:
        f.write(icg())
        f.close()
def savelr0():
    import os
    import sys
    with open(os.path.join(sys.path[0], "lr0.cpp"), "w") as f:
        f.write(lr0())
        f.close()
def savepp():
    import os
    import sys
    with open(os.path.join(sys.path[0], "predictiveparser.py"), "w") as f:
        f.write(pp())
        f.close()
def savertn():
    import os
    import sys
    with open(os.path.join(sys.path[0], "regulartonfa.py"), "w") as f:
        f.write(rtn())
        f.close()
def saventd():
    import os
    import sys
    with open(os.path.join(sys.path[0], "nfatodfa.py"), "w") as f:
        f.write(ntd())
        f.close()
def savefaf():
    import os
    import sys
    with open(os.path.join(sys.path[0], "firstandfollow.py"), "w") as f:
        f.write(faf())
        f.close()
def savela():
    import os
    import sys
    with open(os.path.join(sys.path[0], "lexicalanalyser.py"), "w") as f:
        f.write(la())
        f.close()
...
def savesrp():
    import os
    import sys
    with open(os.path.join(sys.path[0], "shiftreduceparser.py"), "w") as f:
        f.write(srp())
        f.close()
def savelat():
    import os
    import sys
    with open(os.path.join(sys.path[0], "leadingandtrailing.cpp"), "w") as f:
        f.write(lat())
        f.close()
def saveqti():
    import os
    import sys
    with open(os.path.join(sys.path[0], "quadstriplesindirect.c"), "w") as f:
        f.write(qti())
        f.close()
def savescg():
    import os
    import sys
    with open(os.path.join(sys.path[0], "simplecodegenerator.c"), "w") as f:
        f.write(scg())
        f.close()
def saveleftfact():
    import os
    import sys
    with open(os.path.join(sys.path[0], "leftfactor.c"), "w") as f:
        f.write(leftfact())
        f.close()
...
def saveleftrec():
    import os
    import sys
    with open(os.path.join(sys.path[0], "leftrecursive.cpp"), "w") as f:
        f.write(leftrec())
        f.close()
...
def savedag():
    import os
    import sys
    with open(os.path.join(sys.path[0], "dag.py"), "w") as f:
        f.write(dag())
        f.close()
