...
class V10PresentationExchange(BaseExchangeRecord):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.trace = trace
        self.qr_id = qr_id
        self.auto_data_ex_id = auto_data_ex_id
...
class V10PresentationExchangeSchema(BaseExchangeSchema):
    ...
    qr_id = fields.Str(
        required=False, description="Automated dataexchange QR ID", example="f0482319-72be-488f-acf2-f3e16581d698",
        allow_none=True
    )

    auto_data_ex_id = fields.Str(
        required=False, description="Automated dataexchange template ID", example="f0482319-72be-488f-acf2-f3e16581d698",
        allow_none=True
    )
