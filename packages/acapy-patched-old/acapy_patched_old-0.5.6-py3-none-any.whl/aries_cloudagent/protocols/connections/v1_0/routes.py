...
@docs(
    tags=["connection"],
    summary="Creates mediator invitation",
)
@querystring_schema(CreateInvitationQueryStringSchema())
async def connections_create_agent_invitation(request: web.BaseRequest):
    """
...
async def register(app: web.Application):
    ...
    app.add_routes(
        [
            ...
            web.get("/.well-known/agent-configuration",
                    connections_create_agent_invitation, allow_head=False),
