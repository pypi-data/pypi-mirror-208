...
from movia.core.analysis.stream.shape import optimal_shape_video
...
from movia.gui.video_preview.audio_player import AudioPlayer
...
class DynamicSheduler:
    ...
    ** Yield in real time the frame updated with the current parameters. **
    ...
    def update_scheduler(self):
        """
        ** Get an updated version of ``movia.core.io.scheduler.scheduler`` iterator. **
        """
        streams, rates = [], []
...
class FrameExtractor(MoviaWidget, QtCore.QThread):
    """
