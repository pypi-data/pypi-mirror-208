...
from movia.core.analysis.graph.find import find_edge_from_edge_tree
from movia.core.analysis.stream.time_backprop import time_backprop as time_backprop_stream
from movia.core.compilation.graph_to_tree import update_trees
...
def time_backprop(
    ...
    """
    ** Graph version of ``movia.core.analysis.stream.time_backprop.time_backprop``. **

    Parameters
    ----------
    graph : networkx.MultiDiGraph
        The assembly graph. The graph is supposed to be updated.
        It means ``movia.core.compilation.graph_to_tree.update_trees`` was called.
    edge : tuple[str, str, str]
