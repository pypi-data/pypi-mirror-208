...
class API(Flask):
    ...
    def __init__(self, import_name: str, logger: Callable | str = "requests.log", print_traceback: bool = True,
                 ...
                 path_to_favicon: str = "favicon.ico", override_swagger: str = None) -> None:
        """
        ...
        if override_swagger is not None:  # Gets a previously generated/written swagger.json file
            with open(override_swagger, "r") as swag_file:
