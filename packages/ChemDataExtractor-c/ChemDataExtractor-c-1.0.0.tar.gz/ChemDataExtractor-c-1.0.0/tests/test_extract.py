...
class TestExtract(unittest.TestCase):
    ...
    def test_cems(self):
        doc = Document('nmn powder')
        # doc = Document('1,4-Butanediol 99.9% Colorless liquid EDUN')
        print(doc.cems)
    ...
    def test_melting_point_heading_salt(self):
        ...
        d = Document(
            Heading('CAS 60142-96-3 99% Purity Neurontin'),
            Paragraph('Melting point  162°C'),
            Paragraph('Boiling point  314.4±15.0 °C(Predicted)'),
            Paragraph('Density 1.058±0.06 g/cm3(Predicted)'),
            Paragraph('Storage Temp 2-8°C'),
        )
