...
def test_process_manifest():
    ...
    assert manifest == {
        ...
        "files": [
            ...
            {
                "fileName": ".lifeomic/nextgen/PA33390/PA33390.modified.somatic.filtered.nrm.vcf.gz",
                "sequenceType": "somatic",
                "type": "shortVariant",
            },
            {
                "fileName": ".lifeomic/nextgen/PA33390/PA33390.modified.germline.filtered.nrm.vcf.gz",
