...
from dnastack.alpha.client.ewes.models import LogType
...
@command(alpha_tasks_command_group,
         'list',
         specs=[
             ArgumentSpec(
                 name='namespace',
...
alpha_runs_command_group.add_command(alpha_tasks_command_group)
