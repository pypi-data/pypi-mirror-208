...
def _transform_to_public_collection(collection: Collection) -> Dict[str, Any]:
    return {
        ...
        if field_name not in ['itemsQuery']
    }
...
def list_collections(context: Optional[str], endpoint_id: Optional[str], no_auth: bool = False,
    ...
    """ List collections """
    show_iterator(output, _get(context, endpoint_id).list_collections(no_auth=no_auth), transform=_transform_to_public_collection)
