...
from commitguard.extension.terminal import ConsoleTerminal as Terminal
...
class TerminalTestCase(unittest.TestCase):
    ...
    def test_print(self, mock_stdout):
        expected_msg = self.reset(f'{self.white(" ")} foo bar').styled_string + "\n"
    ...
    def test_with_indent(self, mock_stdout):
        expected_msg = self.reset(f'{self.white(" ")}   foo').styled_string + "\n"
