...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/vehicles/{vin}/environment".format(client.base_url, vin=vin)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[EnvironmentResponse, ErrorResponse]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[EnvironmentResponse, ErrorResponse]]:
    return Response(
