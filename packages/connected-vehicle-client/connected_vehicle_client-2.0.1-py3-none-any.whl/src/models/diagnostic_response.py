...
if TYPE_CHECKING:
    from ..models.diagnostic_vals import DiagnosticVals
...
class DiagnosticResponse:
    ...
    Attributes:
        ...
        data (Union[Unset, DiagnosticVals]):
    """

    status: Union[Unset, int] = UNSET
    operation_id: Union[Unset, str] = UNSET
    data: Union[Unset, "DiagnosticVals"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = DiagnosticVals.from_dict(_data)
