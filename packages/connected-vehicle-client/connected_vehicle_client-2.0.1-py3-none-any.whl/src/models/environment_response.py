...
if TYPE_CHECKING:
    from ..models.environment_vals import EnvironmentVals
...
class EnvironmentResponse:
    ...
    Attributes:
        ...
        data (Union[Unset, EnvironmentVals]):
    """

    status: Union[Unset, int] = UNSET
    operation_id: Union[Unset, str] = UNSET
    data: Union[Unset, "EnvironmentVals"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = EnvironmentVals.from_dict(_data)
