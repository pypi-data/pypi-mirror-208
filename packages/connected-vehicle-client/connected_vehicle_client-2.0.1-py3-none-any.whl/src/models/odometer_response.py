...
T = TypeVar("T", bound="OdometerResponse")
...
class OdometerResponse:
    ...
    Attributes:
        ...
        data (Union[Unset, Odometer]):
    """

    status: Union[Unset, int] = UNSET
    operation_id: Union[Unset, str] = UNSET
    data: Union[Unset, "Odometer"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = Odometer.from_dict(_data)

        odometer_response = cls(
            status=status,
            operation_id=operation_id,
            data=data,
        )

        odometer_response.additional_properties = d
        return odometer_response
