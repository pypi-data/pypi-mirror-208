...
from ...models.engine_diagnostic_response import EngineDiagnosticResponse
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/vehicles/{vin}/engine".format(client.base_url, vin=vin)
...
) -> Optional[Union[EngineDiagnosticResponse, ErrorResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = EngineDiagnosticResponse.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[EngineDiagnosticResponse, ErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[EngineDiagnosticResponse, ErrorResponse]
    """
