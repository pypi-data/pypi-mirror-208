...
from demo.features.om.login_page import LoginPage, teardown_logout


@allure.suite("正常")
class TestCaseUILoginNormal(metaclass=CaseMetaClass):
    ...
    @pytest.mark.CI
    def test_logout_1001(self, teardown_logout):
        """正常登录成功"""
        self.login_page.login_success()


@allure.suite("异常")
class TestCaseUILoginNegative(metaclass=CaseMetaClass):
    login_page = LoginPage()
