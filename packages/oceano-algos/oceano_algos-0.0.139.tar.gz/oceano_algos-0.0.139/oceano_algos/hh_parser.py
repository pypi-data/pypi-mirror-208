...
__all__ = ['TextPreprocessor', 'preprocess_string', 'preprocess_series', 'HeadHunterScrapper',
           ...
           'get_professionalroles_id_vs_name', 'SimilarityFinder', 'get_url_vs_similarity', 'Telegram', 'send_vacancy',
           'send_recommended_vacancies_to_chatid', 'send_recommended_vacancies_to_chatids_with_status_1']
...
"""
        ...
        button2   =  InlineKeyboardButton(text="❌ Удалить", callback_data="delete_vacancy")
        keyboard.add(button2)

        button3   =  InlineKeyboardButton(text="⚙️ Настроить поиск", callback_data="settings")
