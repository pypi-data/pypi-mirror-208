...
__all__ = ['welcome_text', 'settings_text', 'after_rocket_text', 'start_search_text', 'stop_search_text',
           'see_search_setting_text', 'no_recommended_vacancies_text', 'proforientation']
...
<b>До конца подписки:</b> {(expiration_date - pd.Timestamp.now()).days} дней {(expiration_date - pd.Timestamp.now()).seconds//3600} часов
