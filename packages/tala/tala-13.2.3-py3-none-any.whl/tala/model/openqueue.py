...
class OpenQueue(AsJSONMixin):
    def __init__(self, front_content=[], back_content=[], unshifted_content=None):
    ...
    def as_dict(self):
        return {
            "openqueue": {
                "front_content": list(object_ for object_ in self.front_content),
                "back_content": list(object_ for object_ in self.back_content),
                "unshifted_content": list(object_ for object_ in self._unshifted_content) if self._unshifted_content else None,
            }
        }
