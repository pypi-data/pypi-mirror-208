...
class HytGpt:
    ...
    def __transcribe_audio_file(self, key_path, file_path) -> start_duration_transcript_t:
    ...
    def __download_youtube_audio(self, url, output_file):
        ...
        cmd = f"{yt_dlp_cmd} --extract-audio --audio-format mp3 --audio-quality 64 --postprocessor-args '-ac 1' '{url}' -o '{output_file}'"
