...
class HytGpt:
    ...
    def __transcribe_youtube_video(
        ...
        HytGpt.update_task_instance(task_instance, 0.95, "Transcription completed.")
    ...
    def __download_youtube_audio(self, url, output_file):
        cmd = f"/usr/local/bin/yt-dlp --extract-audio --audio-format mp3 --audio-quality 64 --postprocessor-args '-ac 1' '{url}' -o '{output_file}'"
