...
def init():
    ...
    if not path.exists("C:\\Windows\\Microsoft.NET\\assembly\\GAC_MSIL\\DevExpress.Data.v22.2"):
        mkdir(f"C:\\Windows\\Microsoft.NET\\assembly\\GAC_MSIL\\DevExpress.Data.v22.2\\")
        mkdir(f"C:\\Windows\\Microsoft.NET\\assembly\\GAC_MSIL\\DevExpress.Data.v22.2\\{version}")
        _ = open(
            f"C:\\Windows\\Microsoft.NET\\assembly\\GAC_MSIL\\DevExpress.Data.v22.2\\{version}\\DevExpress.Data.v22.2.dll",
            "wb+")
        from tkfly._devexpress._com_lib import devexpress_data_base64
        _.write(devexpress_data_base64)
