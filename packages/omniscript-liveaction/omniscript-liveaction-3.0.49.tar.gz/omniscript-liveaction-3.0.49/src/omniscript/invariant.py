...
"""DMS"""
DMS_BACKUP_STATUS_SUCCESS = 'success'
DMS_BACKUP_STATUS_FAILED = 'failed'
DMS_BACKUP_STATUS_DELETED = 'deleted'
DMS_BACKUP_STATUS = [
    DMS_BACKUP_STATUS_SUCCESS,
    DMS_BACKUP_STATUS_FAILED,
    DMS_BACKUP_STATUS_DELETED,
]

DMS_IP_ASSIGNMENT_DHCP = "dhcp"
DMS_IP_ASSIGNMENT_STATIC = "static"
DMS_IP_ASSIGNMENT = [
    DMS_IP_ASSIGNMENT_DHCP,
    DMS_IP_ASSIGNMENT_STATIC,
]

DMS_RESTORE_STATUS_IDLE = "idle"
DMS_RESTORE_STATUS_RUNNING = "running"
DMS_RESTORE_STATUS_COMPLETE = "complete"
DMS_RESTORE_STATUS_ERROR = "error"
DMS_RESTORE_STATUS = [
    DMS_RESTORE_STATUS_IDLE,
    DMS_RESTORE_STATUS_RUNNING,
    DMS_RESTORE_STATUS_COMPLETE,
    DMS_RESTORE_STATUS_ERROR,
]

DMS_RESTORE_SETTINGS_APPLICATION = "application"
DMS_RESTORE_SETTINGS_APPLICATION_SYSTEM = "application_system"
DMS_RESTORE_SETTINGS = [
    DMS_RESTORE_SETTINGS_APPLICATION,
    DMS_RESTORE_SETTINGS_APPLICATION_SYSTEM,
]


@unique
class DMSAutenticaionType(IntEnum, metaclass=OmniEnumMeta):
    RADIUS = 0
    TACACS_PLUS = 1
    ACTIVE_DIRECTORY = 2
    KERBEROS = 3
...
@unique
class DMSLicenseType(IntEnum, metaclass=OmniEnumMeta):
    UNKNOWN = 0
    PERPETUAL = 1
    TRIAL = 2
    SUBSCRIPTION = 3
...
@unique
class DMSTSRSeverity(IntEnum, metaclass=OmniEnumMeta):
    WARNING = 0
    CRITICAL = 1
