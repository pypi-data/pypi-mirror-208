...
class Correspondence(NamedTuple):
    ...
    def to_records(self, api_version: int, api_name: str, download_date: datetime) -> list[dict]:
        ...
        for correspondence_map in self.correspondence_maps:
            record: dict = {}
            record["fra_klassifikasjon_id"] = self.source_classification_id
            record["fra_versjon_id"] = self.source_version_id
            record["til_klassifikasjon_id"] = self.target_classification_id
            record["til_versjon_id"] = self.target_version_id
...
class Version(NamedTuple):
    ...
    def to_records(self, api_version: int, api_name: str, download_date: datetime) -> list[dict]:
        ...
        for classification_item in self.classification_items:
            record: dict = {}
            record["klassifikasjon_id"] = self.classification_id
            record["versjon_id"] = self.version_id
