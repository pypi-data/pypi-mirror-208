...
/**
 * This api is newly added by xusz at 20220520
 * The function of the api is to get config about gpio_v2_line_config
 * gpiotools_request_config() - get the config of gpio(s)
 * @device_name:	The name of gpiochip without prefix "/dev/",
 *			        such as "gpiochip0"
 *
 * lineoffset:		GPIO offset on GPIOchip0/1
 *
 * @config:		    The new config for requested gpio. Reference
 *			        "linux/gpio.h" for config details.
 *
