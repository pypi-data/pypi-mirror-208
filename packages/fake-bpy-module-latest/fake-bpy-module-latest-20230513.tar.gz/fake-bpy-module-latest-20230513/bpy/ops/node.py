...
def collapse_hide_unused_toggle(
        ...
        execution_context: typing.Union[str, int] = None,
        undo: typing.Optional[bool] = None):
    ''' Toggle collapsed nodes and hide unused sockets :File: `startup/bl_operators/node.py\:207 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/node.py#L207>`__
...
def tree_path_parent(override_context: typing.
                     ...
                     execution_context: typing.Union[str, int] = None,
                     undo: typing.Optional[bool] = None):
    ''' Go to parent node tree :File: `startup/bl_operators/node.py\:237 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/node.py#L237>`__
