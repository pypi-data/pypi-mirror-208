...
class Ipo(BaseModel):
    ...
    # To override the default comparison operators, so that we can sort the Ipo objects by open date
    # def __lt__(self, obj):
    #     return ((self.open_date) < (obj.open_date))
