...
from src.utils.exceptions import InvalidPILImageMode
...
def get_img_files(img_dir: Path, img_formats: List[str] = ['jpg', 'png'],
    ...
    return get_all_files(dir_path=img_dir,
                         file_formats=img_formats,
                         with_batch_structure=with_batch_structure,
                         skip_dirs=skip_dirs)
...
def load_images(path: Path, transformer: Callable = None,
                loader: str = "PIL",
                img_formats: List[str] = ['jpg', 'png', 'jpeg']) -> List:
