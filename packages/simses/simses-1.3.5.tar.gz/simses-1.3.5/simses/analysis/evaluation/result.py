...
class Description:
    ...
    class Technical:
        ...
        C_RATE_CHARGING: str = 'Avg. C-rate charging'
        C_RATE_DISCHARGING: str = 'Avg. C-rate discharging'
        ...
        SYSTEM_TEMPORAL_UTILIZATION: str = 'System temporal utilization in p.u.'
        E_RATE_CHARGING: str = 'Avg. E-rate charging'
        E_RATE_DISCHARGING: str = 'Avg. E-rate discharging'
        STORAGE_TECHNOLOGY_TEMPORAL_UTILIZATION: str = 'Storage technology temporal utilization in p.u.'
