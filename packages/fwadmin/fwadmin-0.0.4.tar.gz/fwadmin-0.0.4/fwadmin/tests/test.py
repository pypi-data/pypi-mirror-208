...
def load_scenario():
    ...
    dynamic_list_all_o = DynamicList.objects.create(
        name="edl_all", rule="EDL_ALL", direction="source"
    )
    ...
    dynamic_list_odd_o = DynamicList.objects.create(
        name="edl_odd", rule="EDL_ODD", direction="source"
    )
    dynamic_list_odd_o.device_groups.add(device_group_odd_o)
    dynamic_list_odd_o.firewalls.add(firewall_1_o, firewall_3_o)

    dynamic_list_even_o = DynamicList.objects.create(
        name="edl_even", rule="EDL_EVEN", direction="source"
    )
    ...
    dynamic_list_empty_o = DynamicList.objects.create(
        name="edl_empty", rule="EDL_EMPTY", direction="source"
    )
