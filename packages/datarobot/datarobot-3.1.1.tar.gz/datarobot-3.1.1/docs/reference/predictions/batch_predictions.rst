...
DataRobot provides a utility function to make batch predictions using a deployment: :meth:`Deployment.predict_batch <datarobot.models.Deployment.predict_batch>`.
